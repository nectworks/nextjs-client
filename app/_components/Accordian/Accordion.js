  ...
  const accordionItems = [
    {
      ...
      content: 'You can either submit a referral request specific to a job posting,' +
    ...
    },
    {
      ...
      content: 'No, while a referrer may guarantee that your application will ' +
    ...
    },
    {
      ...
      content: 'Once you get referred, you might receive an email with' +
      ' further instructions for the next process.',
    },
    {
      title: 'How long does it take to get referred?',
      content: 'Once a referral request is submitted, ' +
    ...
    },
    {
      ...
      content: 'If you have any other queries that you wish to get resolved, let us know at Contact Us',
    },
  ];
