    ...
    <main className="about-page">
        ...
        <div className="about-container">
          <div className="about-hero-content">
            ...
            <h1 className="about-hero-title">
              <span className="text-highlight">Designing </span>a Seamless Candidate Journey - From Application to Offer.
            </h1>
            <div className="hero-image-grid">
              <div className="hero-image-item"><img src={AboutBGPic1.src} alt="Team collaboration" /></div>
              <div className="hero-image-item"><img src={AboutBGPic2.src} alt="Professional networking" /></div>
              <div className="hero-image-item"><img src={AboutBGPic3.src} alt="Career growth" /></div>
              <div className="hero-image-item"><img src={AboutBGPic4.src} alt="Digital recruitment" /></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="about-section">
        <div className="about-container">
          ...
          <div className="about-text animation-container">
            <p>
              Behind every job is a person with potential — and someone willing to open a door.
              At Nectworks, we’re reimagining job referrals to make them more human, intentional, and impactful.
              We help job seekers be seen for who they are — beyond resumes and algorithms — and empower referrers to spark real opportunity with a single act of support.
            </p>
            ...
            <p>
              At Nectworks, we believe every referral can be that tree. A simple gesture today can change someone’s tomorrow.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="about-container">
          <div className="mission-container">
            <div className="mission-image animation-container">
              <img src={AboutImgThirdSection.src} alt="Nectworks mission illustration" />
            </div>
